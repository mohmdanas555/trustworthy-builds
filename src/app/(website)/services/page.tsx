...
import { ArrowRight, CheckCircle, Smartphone, Home, Building2, Hammer, Paintbrush, ClipboardList } from "lucide-react";
                            ...
                            >
                                ...
                                <div className={`${index % 2 === 1 ? "lg:order-1" : ""} animate-slide-left`}>
                                    <div className="bg-muted rounded-2xl p-8 aspect-square flex items-center justify-center">
                                        <DynamicIcon name={service.icon} className="w-32 h-32 text-primary/20" />
                                    </div>
                                </div>
                            </div>
                        ))}

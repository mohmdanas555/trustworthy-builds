...
VALUES 
('Civil Engineering', 'Building2', 'Structural design and analysis for large-scale infrastructure projects including bridges and highways.', ARRAY['Site Analysis', 'Structural Design', 'Project Oversight']),
('Residential Construction', 'Home', 'Bespoke luxury villa construction and residential developments in key Dubai locations.', ARRAY['Custom Design', 'Premium Finish', 'Turnkey Delivery']),
('Industrial Facilities', 'Factory', 'Specialized construction for logistics hubs, factories, and heavy industrial plants.', ARRAY['Robust Infrastructure', 'Safety Certification', 'Logistics Planning']),
('Project Management', 'Layout', 'Full-cycle management from planning through execution to ensure on-time delivery.', ARRAY['Cost Control', 'Scheduling', 'Quality Assurance']),
('Commercial Renovation', 'ShoppingBag', 'State-of-the-art office and retail space fit-outs and comprehensive structural renovations.', ARRAY['Modern Design', 'Speedy Execution', 'Retail Standards'])
